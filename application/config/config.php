...
$config['sess_save_path'] = 'tcp://127.0.0.1:6379';//'tcp://host1:6379?weight=1, tcp://host2:6379?weight=2&timeout=2.5, tcp://host3:6379?weight=2&read_timeout=2.5';//sys_get_temp_dir();
